...
def get_side_data():
    side_data = pickle.load(open("data/hredial/side_data.pkl", "rb"))["entity_kg"]["edge"]
    entity2id = json.load(open("data/hredial/entity2id.json", "r", encoding="utf-8"))
    ...
    word_side = {}
    token_set = set([token.lower() for token in json.load(open("data/hredial/token2id.json", "r", encoding="utf-8"))])
