...
class KGSFModel(torch.nn.Module):
    ...
    def rec_forward(
        ...
        rec_scores = F.linear(user_embedding, entity_graph_representations, self.rec_bias.bias)
    ...
    def con_forward(
        ...
        user_embedding = []
        for entity_list, word_list in zip(related_entity, related_words):
            entity_representations = entity_graph_representations[entity_list]
            word_representations = word_graph_representations[word_list]
