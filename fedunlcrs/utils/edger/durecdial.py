...
def get_side_data():
    side_data = []
    with open("data/durecdial/entity_subkg.txt", "r", encoding="utf-8") as file:
    ...
    word_side = {}
    token_set = set([token.lower() for token in json.load(open("data/durecdial/token2id.json", "r", encoding="utf-8"))])
